...
const STYLE_CONFIG = {
  'ИНФОРМИРОВАНИЕ': {
    ...
    summary: `
      <p>Ваш результат: <strong>Директивный стиль руководства</strong> <br/><em>У вас ярко выражен директивный (инструктирующий) стиль руководства.</em></p></br>
  ...
  'ОБУЧЕНИЕ': {
    ...
    title: 'ОБУЧЕНИЕ',
    summary: `
      <p>Ваш результат: <strong>Обучающий стиль руководства</strong><br/> <em>У вас ярко выражен обучающий (коучинговый) стиль руководства.</em></p></br>
  ...
  'ПОДДЕРЖКА': {
    ...
    summary: `
      ...
      <em>У вас выражен поддерживающий (совместный) стиль руководства.</em></p><br/>
        ...
        <div className={styles.summary}>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: mainStyle.summary.replace(
                /<em>/g,
